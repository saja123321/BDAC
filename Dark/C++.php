...
$s = "select * from user_courses where user_name= '$name' && cours_id = '1'";
...
<script>
  ...
  function en() 
  {
      ...
      var num = "<?php echo(json_encode($num)); ?>";
        if (num==0)
      {  
        location.href = 'enroll.php?c=1';
        
      }

      else {
        location.href = 'un.php?c=1';
      }
...
<img src="images/c++.png" class="img-fluid">
</div>
</div>
</div>
...
<div class="row text-center">
  ...
  <?php
     ...
     $fetchVideos = mysqli_query($con, "SELECT vid_location , vid_description FROM course_video where course_id='1' ORDER BY `course_video`.`time_added` ASC");
