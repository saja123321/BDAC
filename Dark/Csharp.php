...
$n=$_COOKIE['userdata'];
  if ($n=='Saja' && $n=='Arar'){
    header('location:../login.php');}
$s = "select * from user_courses where user_name= '$name' && cours_id = '5'";
...
<script>
  ...
  function en() 
  {
      ...
      var num = "<?php echo(json_encode($num)); ?>";
        if (num==0)
      {  
        location.href = 'enroll.php?c=5';
        
      }

      else {
        location.href = 'un.php?c=5';
      }
...
<div class="row">
<div class="col-md-6">
<p class="promo-title"> Learn C# </p>
<p>Here you can the best way you want to learn C# Just click on Enroll now to get it </p>
<input onclick="en()" type="button" value="Enroll Now" id="myButton2" class="btn btn-primary"></input> 
</div>
<div class="col-md-6 text-center">
<img src="images/Csharp.png" class="img-fluid">
</div>
</div>
</div>
...
$fetchVideos = mysqli_query($con, "SELECT vid_location , vid_description FROM course_video where course_id='5' ORDER BY `course_video`.`time_added` ASC");
