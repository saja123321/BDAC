    ...
    $fileType = pathinfo($targetFilePath,PATHINFO_EXTENSION);
        ...
        if(in_array($fileType, $allowTypes)){
            ...
            if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
                ...
                $insert = mysqli_query($con, "UPDATE `teachertable` SET `image`='$fileName' WHERE  `teachertable`.`name`='$n'");
            } 
          }  
        }
    ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          ...
          <a href="upload_video.php" target="_self"> upload video </a> </br> 
...
<section id="account">
    ...
    <a class="btn0" href="techercourses.php" target="_self">My Courses</a> </br>
    </br>
  
    <a class="btn0" href="upload_video.php" target="_self"> upload video </a> </br> 

    </div>
    <div class="col-md-6 text-center" class="img-fluid">
    <?php
   $query =  mysqli_query($con,"SELECT * FROM teachertable WHERE `name`='$n' ");
   if(!$query) {
    printf("Error: %s\n", mysqli_error($con));
    exit();
   }
   ...
   <form action="teacheraccount.php" method="post" enctype="multipart/form-data">
   </br>
