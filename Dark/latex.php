...
<div class="row">
<div class="col-md-6">
<p class="promo-title"> Learn LaTex </p>
<p>Here you can the best way you want to learn LaTex Just click on Enroll now to get it </p>
<input onclick="en()" type="button" value="Enroll Now" id="myButton2" class="btn btn-primary"></input> 
</div>
<div class="col-md-6 text-center">
<img src="images/latex.png" class="img-fluid">
</div>
</div>
</div>
...
$fetchVideos = mysqli_query($con, "SELECT vid_location , vid_description FROM course_video where course_id='4' ORDER BY `course_video`.`time_added` ASC");
